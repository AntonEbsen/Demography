...
def franco_prussian_war_analysis(df: pd.DataFrame):
    ...
    ax.set_title("Franco-Prussian War shock vs Kulturkampf", fontsize=13, fontweight="bold")
...
def robustness_exclude_war(
    ...
    ax.set_title(f"Event study excluding war years {war_years}", fontsize=13, fontweight="bold")
